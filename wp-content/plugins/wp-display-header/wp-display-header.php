...
class Obenland_Wp_Display_Header extends Obenland_Wp_Plugins_v301 {
	...
	protected function header_selection_form( $active = '' ) {
		...
		<div class="available-headers">
			...
			<?php submit_button( esc_html__( 'Restore Original Header Image' ), 'button', 'wpdh-reset-header', false ); ?>
			<span class="description"><?php esc_html_e( 'This will restore the original header image. You will not be able to restore any customizations.' ) ?></span>
		</div>
	<?php
	}
