...
<?php while (have_posts()) : the_post(); ?>
	...
	<div id="mrktg-content" class="container">
		...
		<div class="entry-content marketing row" style="margin-top: 40px;">
			<div class="col-md-12">
<!-- Begin Easy Locator Store Locator Service //-->
<script type="text/javascript" src="//www.easylocator.net/api/embedIframe/Mode2.0-Test-Desktop/controller/search/function/map3/template/template3_2"></script><div id="EasyLocatorWrapper"></div>
